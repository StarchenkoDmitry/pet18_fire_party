            ...
            <div className={styles.content} onClick={(e)=>e.stopPropagation()}>
                ...
                <div className={styles.editor}>
                    ...
                    <div className={styles.editorSettings}>
                        ...
                        <input onChange={loadFileToImage} ref={inputFile} type="file" id="file" style={{display:"none"}} />
                        <button onClick={openFinderFile} className={styles.btn_file}>Add a picture file</button>
                        ...
                        <button className={styles.btn_save} onClick={doSaveImage}>Save</button>
                    </div>
                </div>
