        ...
        <div className={styles.page}>
            ...
            <div className={styles.registerform}>
                <form onSubmit={onSubmit} method="POST" action="/">
                    ...
                    <input name="surname" value={surname} onChange={changeSurname} />

                    <label htmlFor="login">Login</label>
                    <input name="login" value={login} onChange={changeLogin} />
                    ...
                    <button className={styles.btn_randomFields} onClick={RandomFields}>
                        Random fields
                    </button>
